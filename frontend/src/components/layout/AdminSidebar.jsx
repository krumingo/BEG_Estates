...
const NAV = [
    ...
    { to: "/admin/area-formation", label: "Площообразуване", icon: Calculator, id: "admin-nav-area-formation" },
    ...
    { to: "/admin/bulk-import", label: "Bulk JSON Import", icon: FileJson, id: "admin-nav-bulk-import" },
