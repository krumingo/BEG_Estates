        ...
        >
            <div className="mx-auto max-w-7xl px-6 lg:px-10 h-16 flex items-center justify-between">
                <Link to="/" data-testid="brand-link" className="flex items-baseline gap-2">
                    <span className={`font-serif text-2xl font-medium tracking-tight ${dark ? "text-white" : "text-slate-900"}`}>
                        BEG Estates
                    </span>
                    <span className={`overline ${dark ? "text-white/50" : "text-slate-500"}`}>EstateFlow</span>
                </Link>
