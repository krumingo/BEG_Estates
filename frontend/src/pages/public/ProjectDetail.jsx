...
export default function ProjectDetail() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <FloorPlanSection projectId={data?.project?.id} />
...
function FloorPlanSection({ projectId }) {
    ...
    useEffect(() => {
        ...
        api.get(`/projects/${projectId}/floor-plans`)
            .then((r) => {
                ...
                setPlans(safe);
                if (safe.length) setActiveFloor(safe[0].floor);
            })
            .catch(() => setPlans([]));
    }, [projectId]);
    ...
    return (
        <section className="bg-white py-20" data-testid="floor-plan-section">
            <div className="mx-auto max-w-7xl px-6 lg:px-10">
                <div className="overline mb-3">Избери по етаж</div>
                <h2 className="font-serif text-4xl sm:text-5xl text-slate-900 mb-8">
                    Планировка по етажи
                </h2>
                        ...
                        <div className="relative inline-block w-full">
                            ...
                            {dims.renderW > 0 && plan.units.map((u) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`h-full w-full border-2 border-white/90 ${st.dot || "bg-slate-500"} opacity-60 group-hover:opacity-85 transition rounded-sm`} />
